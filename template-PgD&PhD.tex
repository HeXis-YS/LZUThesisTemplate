...
% 统一中文字体族，避免仅使用 ctex 默认 Fandol 导致部分 PDF 预览器中文渲染异常
\IfFontExistsTF{Noto Serif CJK SC}{%
  \setCJKmainfont{Noto Serif CJK SC}%
  \IfFontExistsTF{Noto Sans CJK SC}{\setCJKsansfont{Noto Sans CJK SC}}{\setCJKsansfont{Noto Serif CJK SC}}%
  \setCJKfamilyfont{zhsong}{Noto Serif CJK SC}%
  \IfFontExistsTF{Noto Sans CJK SC}{\setCJKfamilyfont{zhhei}{Noto Sans CJK SC}}{\setCJKfamilyfont{zhhei}{Noto Serif CJK SC}}%
  \setCJKfamilyfont{zhkai}{Noto Serif CJK SC}%
  \setCJKfamilyfont{zhfs}{Noto Serif CJK SC}%
}{%
  \IfFontExistsTF{Source Han Serif SC}{%
    \setCJKmainfont{Source Han Serif SC}%
    \IfFontExistsTF{Source Han Sans SC}{\setCJKsansfont{Source Han Sans SC}}{\setCJKsansfont{Source Han Serif SC}}%
    \setCJKfamilyfont{zhsong}{Source Han Serif SC}%
    \IfFontExistsTF{Source Han Sans SC}{\setCJKfamilyfont{zhhei}{Source Han Sans SC}}{\setCJKfamilyfont{zhhei}{Source Han Serif SC}}%
